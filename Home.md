...
# 🎯 AI Career English — Dashboard

> **Goal:** AI Engineer in Southern Germany 🇩🇪 | **Timeline:** 12 Months
> **Background:** M.Sc. KIT | 3yr SWE (C#, C++, AutoCAD)
...
- [ ] ML Knowledge (target: 80% confidence explaining to interviewer)
- [ ] English Speaking (target: smooth 60-second technical explanations)
- [ ] German Workplace (target: participate in German meetings by month 3)
- [ ] Interview Readiness (target: pass mock interview by month 3)
